...
export const Experience = (props) => {
  ...
  useEffect(() => {
    ...
    setTimeout(() => {
      setCharacterAnimation(section === 0 ? "Typing" : "Breathing");
...
<motion.group
  ...
  variants={{
    ...
    4: {
      y: isMobile ? -viewport.height * 4 + 2 : -viewport.height * 4 + 1.2 ,
      x: isMobile ? 0.04 : 0.1,
      z: isMobile ? 9.1 : 8.4,
      rotateX: 0,
      rotateY: 0,
...
>
  <Avatar animation={characterAnimation} wireframe={section===1} section={1} />
</motion.group>
